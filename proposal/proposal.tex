...
% Extra top margin on the first page (geometry top=0.7in + this 0.3in = 1.0in for page 1 only).
\vspace*{0.3in}
...
\textbf{Brian Bingham}, Naval Postgraduate School, Monterey, CA, USA.
%\; \href{mailto:bbingham@nps.edu}{bbingham@nps.edu}.
\emph{Bio.} Brian Bingham is a Professor at the Naval Postgraduate School. He works on marine robotics, autonomy, and the simulation tools that support both. He is interested in simulation tools for marine robotics.  His current focus is on what fidelity is actually needed for ocean simulation to serve as a daily tool for autonomy development.

\textbf{Christine Buzzell}, Autonomy Focus Area Lead / Program Officer, Office of Naval Research (ONR), Arlington, VA, USA.
%\; \href{mailto:christine.m.buzzell.civ@us.navy.mil}{christine.m.buzzell.civ@us.navy.mil}.
\emph{Bio.} Christine Buzzell is the U.S Office of Naval Research Autonomy Focus Area Lead, in this role she leads a team of Program Officers in defining the roadmap for autonomy development for future years. As a Program Officer in the Advanced Naval Platforms Division (331) she manages multiple programs, all related to maritime autonomy, including basic research in the Cooperative Autonomous Swarm Technology (CAST) program, early applied research under the New Concepts in Sea Weapons program, co-lead on a persistent autonomous system Innovative Naval Prototype (INP) involving UUVs, and numerous contracts related to collaborative autonomous systems. Her work on autonomous maritime systems began at the Naval Undersea Warfare Center (NUWC) in Newport, RI writing software for underwater vehicle; She brings the workshop a funding-agency perspective on shared infrastructure for marine autonomy and how it should be sustained.

% CLAUDE: bio drafted from public sources (BYU FRoSt Lab and ECE department pages); pending Joshua's confirmation. Email confirmed by user.
\textbf{Joshua Mangelson}, Brigham Young University, Provo, UT, USA.
%\; \href{mailto:joshua_mangelson@byu.edu}{joshua\_mangelson@byu.edu}.
%\emph{Bio.} Joshua Mangelson is an Assistant Professor of Electrical and Computer Engineering at Brigham Young University, where he founded and directs the Field Robotic Systems (FRoSt) Lab. His research covers robotic perception, navigation, SLAM, and the development of autonomous underwater and surface vehicles, with a focus on marine field trials. The FRoSt Lab develops and maintains HoloOcean, an Unreal-Engine-based marine robotics simulator. Before joining BYU in 2020, he held postdoctoral appointments in Naval Architecture and Marine Engineering at the University of Michigan and at Carnegie Mellon University's Field Robotics Center. He received his PhD and MS in Robotics from the University of Michigan.

% CLAUDE: confirm Evan's preferred email address.
\textbf{Evan Palmer}, Oregon State University, Corvallis, OR, USA.
\emph{Bio.} Evan Palmer is a Robotics Ph.D. student at Oregon State University. He studies the intersection of geometric methods and machine learning for underwater vehicles, leveraging marine robotics simulation to bridge the gap between theory and field deployment. He is a former co-organizer of the ROS Maritime Community Group: an international group of marine robotics researchers and engineers dedicated to advancing open-source marine simulation and software.

% CLAUDE: confirm Ivan's preferred email address.
\textbf{Ivan Stenius}, KTH Royal Institute of Technology, Stockholm, Sweden.
\emph{Bio.} 
Ivan Stenius is Associate Professor in Naval Architecture at KTH Royal Institute of Technology, Stockholm. His work spans marine robotics, underwater vehicle design, modelling, manoeuvring, navigation, and simulation-supported autonomy. Since initiating the Swedish Maritime Robotics Centre, SMaRC, in 2017, he has pushed the use of simulated environments as a practical tool for underwater robotics development, from MATLAB/Simulink models to Gazebo, Stonefish, and more recently KTH’s Unity-based simulation environment coupled to ROS. He brings experience from AUV development, field experimentation, and Swedish marine-robotics research infrastructure to the workshop.

\textbf{Mabel Zhang}, Anduril Industries, Boston, MA, USA.
%\; \href{mabelzhang.github@gmail.com}{mabelzhang.github@gmail.com}.
\emph{Bio.} Mabel Zhang’s research background is in visuotactile perception for manipulation (PhD, GRASP Labs, University of Pennsylvania, 2018). Then for 5 years (2019-2024) at Open Source Robotics Foundation (OSRF), she was a core developer and maintainer of ROS 2 and new Gazebo, where she collaborated with clients in marine robotics simulators like DAVE Aquatic Virtual Environment (DAVE), Virtual RobotX (VRX), MBARI Long-Range AUV simulator, and the MBARI Wave Energy Converter Gazebo simulator. Currently (2025-), she works on safety-critical software certification for AUVs at Anduril Industries. Outside of robotics, she partakes in marine science as a fish biology student at the University of Washington’s Friday Harbor Labs, WA, USA (Jul-Aug 2023), and postdoc (2024-2025) in energy transition at Heriot-Watt University in Orkney Islands, Scotland to gain exposure to marine renewable energy and marine survey and planning in the North Sea.
