...
% CLAUDE: bio drafted from public sources (ONR program pages and 2005 UMass Marine newsletter); pending Christine's confirmation.
\textbf{Christine Buzzell}, Office of Naval Research, Arlington, VA, USA.
%\; \href{mailto:christine.m.buzzell.civ@us.navy.mil}{christine.m.buzzell.civ@us.navy.mil}.
%\emph{Bio.} Christine Buzzell is a Program Officer at the U.S.\ Office of Naval Research (Code 331), where she manages the Cooperative Autonomous Swarm Technology (CAST) program, which develops technologies for cooperative operations of unmanned underwater and surface vehicles. Her work on autonomous maritime systems began at the Naval Undersea Warfare Center (NUWC) in Newport, RI; her master's research --- supported by an ONR University Laboratory Initiative grant --- produced a command-and-control language for heterogeneous underwater robotic vehicles. She brings the workshop a funding-agency perspective on shared infrastructure for marine autonomy and how it should be sustained.
